...
RayPrecision Perlin::turb(const RayVec3& p, int depth) const{
	auto accum = 0.0f;
	auto temp_p = p;
	auto weight = 1.0f;
...
RayPrecision Perlin::perlin_interp(RayVec3 c[2][2][2], RayPrecision u, RayPrecision v, RayPrecision w) {
