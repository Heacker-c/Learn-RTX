#include "Public/Ingredients/glslprogram.h"
#include "Public/Ingredients/glutils.h"
#include "Public/Ingredients/ShaderIncludes.h"
...
void GLSLProgram::compileShader(const std::string& fileName)
{
    ...
    compileShader(fileName.c_str(), type);
}
...
{
    std::string source = ShaderInclude::Load(fileName);
    if (source.empty())
    {
