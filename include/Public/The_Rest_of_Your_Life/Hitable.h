...
namespace RTX 
{
	...
	public:
        ...
        virtual bool boundingBox(RayPrecision t0, RayPrecision t1, AABB& output_box) const = 0;
        virtual RayPrecision pdfValue(const RayVec3& o, const RayVec3& v) const { return 0.0f; }
        virtual RayVec3 random(const RayVec3& o) const { return RayVec3(1.0f, 0.0f, 0.0f); }
	};
}
#endif