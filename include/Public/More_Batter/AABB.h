...
#define findMaxAndMin(val,type)                                 \
if (val.##type > _max.##type)  _max.##type = val.##type;        \
else if (val.##type < _min.##type) _min.##type = val.##type;
...
namespace RTX 
{
    ...
    public:
        ...
        AABB(const RayVec3& p1, const RayVec3& p2, const RayVec3& p3)
        {
            _min = _max = p1;
